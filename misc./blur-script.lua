return function(target)
	...
	target:SetAttribute("BlurIntensity", START_INTENSITY)

	local BLUR_OBJ          = Instance.new("DepthOfFieldEffect")
	BLUR_OBJ.FarIntensity   = 0
	BLUR_OBJ.NearIntensity  = target:GetAttribute("BlurIntensity")
	...
	function BlurredGui.updateAll()
		BLUR_OBJ.NearIntensity = tonumber(target:GetAttribute("BlurIntensity"))
	...
	BlurredGui.new(target, "Rectangle")
	BlurredGui.updateAll()
	return BlurredGui
end
